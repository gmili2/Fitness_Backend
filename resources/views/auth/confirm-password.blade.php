        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header text-center" style="background: linear-gradient(135deg, #dc3545 0%, #c82333 100%); color: white;">
                    <h4 class="mb-0">
                        <i class='bx bx-shield me-2'></i>{{ __('Zone sécurisée') }}
                    </h4>
                </div>

                <div class="card-body" style="background-color: #f8f9fa;">
                    <div class="text-muted mb-4">
                        <i class='bx bx-info-circle me-2'></i>{{ __('Il s\'agit d\'une zone sécurisée de l\'application. Veuillez confirmer votre mot de passe avant de continuer.') }}
                    </div>
                    ...
                    <form method="POST" action="{{ route('password.confirm') }}">
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-danger w-100">
                                <i class='bx bx-check-shield me-2'></i>{{ __('Confirmer') }}
                            </button>
