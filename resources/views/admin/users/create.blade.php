    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header">
                <h6 class="mb-0" style="font-weight:600"><i class='bx bx-building-house me-2 text-danger'></i>Informations de la salle</h6>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('admin.users.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-4 text-center">
                        ...
                        <label for="image" class="btn btn-light border" style="border-radius:8px;font-size:.8rem;cursor:pointer">
                            <i class='bx bx-upload me-1'></i> Choisir une photo
                        </label>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                                    value="{{ old('name') }}" placeholder="Ex: FitZone Casablanca" required>
                            </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" name="email" class="form-control @error('email') is-invalid @enderror"
                                    value="{{ old('email') }}" placeholder="contact@salle.ma" required>
                            </div>
                    ...
                    <div class="d-flex gap-2 mt-4 pt-2 border-top">
                        <button type="submit" class="btn-primary-custom">
                            <i class='bx bx-check'></i> Enregistrer la salle
                        </button>
                        <a href="{{ route('admin.users') }}" class="btn btn-light border" style="border-radius:8px;font-size:.875rem;padding:9px 16px">
                            Annuler
                        </a>
