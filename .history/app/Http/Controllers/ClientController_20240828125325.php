...
try{
    $client = $this->user->clients()->create([
        ...
        'created_at' => now(),  // Utilisation de now() pour remplir la date de création
        'updated_at' => now(),  // Utilisation de now() pour remplir la date de mise à jour
    ]);
}
catch(\Exception $e){
    dd($e);
